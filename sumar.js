...
function generarOperacion(){ 
  var num1 = Math.floor(Math.random() * 10),
      ...
      respuest1 = Math.floor(Math.random() * 10),
      respuest2 = Math.floor(Math.random() * 10),
      allAnswers = [],
      listRespuestas = [];
  ...
  for (i = allAnswers.length; i--;){
    listRespuestas.push(allAnswers.splice(Math.floor(Math.random() * (i + 1)), 1));
  };
